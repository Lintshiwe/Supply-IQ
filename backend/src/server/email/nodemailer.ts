...
export async function sendActivationKeyEmail(
  ...
  const mailOptions = {
    from: `"Stackwise" <${process.env.SMTP_USER || "noreply@stackwise.app"}>`,
    to,
    subject: "Your Stackwise Activation Key",
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="background: #f8fafc; padding: 40px 32px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 12px 12px;">
          <h2 style="color: #0f172a; margin: 0 0 16px 0; font-size: 20px;">Welcome to Stackwise!</h2>
          <p style="color: #475569; margin: 0 0 24px 0; font-size: 16px; line-height: 1.5;">
            Hi ${userName},<br><br>
            Thank you for subscribing to Stackwise. Your activation key is ready:
          </p>
          ...
          <p style="color: #475569; margin: 0 0 16px 0; font-size: 14px; line-height: 1.5;">
            1. Open the Stackwise application<br>
