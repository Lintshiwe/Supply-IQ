      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <a href="#" className="flex items-center">
          <span className="text-lg font-semibold tracking-tight">
            Supply<span className="text-accent-foreground bg-accent px-1 rounded-sm">IQ</span>
          </span>
        </a>
        ...
        <div className="flex-1">
          <BrowserFrame>
            <img
              ...
              alt={`SupplyIQ ${featureTabs[activeTab].label} view`}
    ...
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="mx-auto max-w-5xl">
            <BrowserFrame className="shadow-2xl shadow-primary/5">
              <img
                ...
                alt="SupplyIQ dashboard showing inventory metrics, stock levels chart, and recent activity"
                className="w-full"
                loading="lazy"
              />
            </BrowserFrame>
        ...
        <div className="mx-auto max-w-3xl rounded-2xl bg-foreground px-6 py-16 text-center sm:px-12 sm:py-20">
          <RevealSection>
            ...
            <p className="mx-auto mt-4 max-w-md text-base text-background/60">
              Explore SupplyIQ with sample data. No signup required.
            </p>
            <div className="mt-8">
              <button
                type="button"
      ...
      <footer className="border-t border-border px-4 py-10 text-center">
        <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
          ...
          <span>Built with SupplyIQ · {new Date().getFullYear()}</span>
        </div>
      </footer>
    </div>
  );
