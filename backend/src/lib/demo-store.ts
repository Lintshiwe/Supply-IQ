...
const SEED_USERS: DemoUser[] = [
  { id: "user-01", name: "Alice Chen", email: "alice@supplyiq.io", role: "admin", status: "active", joinedAt: new Date(Date.now() - 90 * 86400000).toISOString() },
  { id: "user-02", name: "Bob Martinez", email: "bob@supplyiq.io", role: "admin", status: "active", joinedAt: new Date(Date.now() - 80 * 86400000).toISOString() },
  { id: "user-03", name: "Carol Kim", email: "carol@supplyiq.io", role: "manager", status: "active", joinedAt: new Date(Date.now() - 60 * 86400000).toISOString() },
  { id: "user-04", name: "David Okafor", email: "david@supplyiq.io", role: "manager", status: "active", joinedAt: new Date(Date.now() - 45 * 86400000).toISOString() },
  { id: "user-05", name: "Eva Novak", email: "eva@supplyiq.io", role: "requestor", status: "active", joinedAt: new Date(Date.now() - 30 * 86400000).toISOString() },
];
