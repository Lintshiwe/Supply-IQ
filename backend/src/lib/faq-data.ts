...
export const FAQ_DATA: FaqCategory[] = [
  {
    ...
    items: [
      { question: "What is SupplyIQ?", answer: "SupplyIQ is an inventory management system that helps you track stock levels, manage suppliers, create purchase orders, and gain insights through analytics." },
