        ...
        <Tabs defaultValue="overview" className="px-6 pt-4 pb-8">
          ...
          <TabsContent value="overview" className="mt-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-4">
              ...
              <DetailRow label="Cost Per Unit" value={`R${Number(item.costPrice || 0).toFixed(2)}`} mono />
              <DetailRow label="Sale Price" value={`R${Number(item.sellingPrice || 0).toFixed(2)}`} mono />
